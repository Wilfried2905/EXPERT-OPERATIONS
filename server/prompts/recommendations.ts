const generateRecommendationsPrompt = (auditData: any) => `En tant qu'expert en audit de datacenters, analysez les données d'audit suivantes et générez des recommandations détaillées pour l'amélioration de l'infrastructure.
...
- Toujours inclure des impacts quantifiés et des délais estimés`;
