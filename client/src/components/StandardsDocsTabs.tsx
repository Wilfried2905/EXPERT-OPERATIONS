...
const ComplianceStatus = ({ status, percentage }: { status: string, percentage: number }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Badge variant={percentage >= 80 ? 'success' : 'warning'}>
        {status}
      </Badge>
    </div>
  );
  ...
  const standards = [
    {
      name: 'TIA-942-B',
      version: '2022',
      description: 'Standard d\'Infrastructure de Télécommunications pour les Centres de Données',
      compliance: 85,
      status: 'Conforme',
      clauses: [
        { id: '5.3', title: 'Architecture', compliance: 90 },
        { id: '6.2', title: 'Installation Électrique', compliance: 85 },
        { id: '7.1', title: 'Systèmes Mécaniques', compliance: 80 },
        { id: '8.4', title: 'Télécommunications', compliance: 85 }
      ]
    },
    {
      name: 'TIA-942-A-1',
      version: '2019',
      description: 'Addenda 1 - Standard d\'Infrastructure de Télécommunications',
      compliance: 75,
      status: 'Partiel',
      clauses: [
        { id: 'A1.1', title: 'Exigences Supplémentaires', compliance: 75 }
      ]
    }
  ];
